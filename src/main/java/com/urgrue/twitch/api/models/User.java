...
public class User {
     ...
     */
    public User(Boolean mature, String status, String broadcasterLanguage, String displayName, String game, String language, String name, String createdAt, String updatedAt, String id, String logo, String videoBanner, String profileBanner, Object profileBannerBackgroundColor, Boolean partner, String url, Integer views, Integer followers) {
        super();
        this.mature = mature;
        this.status = status;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(mature).append(status).append(broadcasterLanguage).append(displayName).append(game).append(language).append(name).append(createdAt).append(updatedAt).append(id).append(logo).append(videoBanner).append(profileBanner).append(profileBannerBackgroundColor).append(partner).append(url).append(views).append(followers).append(additionalProperties).toHashCode();
    }
